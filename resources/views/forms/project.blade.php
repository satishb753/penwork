<div id="project" class="hidden">
    <form action="{{ route('project.fill') }}" method="post" enctype="multipart/form-data">

        <div class="col-md-6">
            <div class="form-group">
                <label for="title">Project Title</label>
                <input type="text" class="form-control" id="title" placeholder="Project Title" name="project_title">
            </div>

            <div class="form-group">
                <label for="category">Project Category</label>
                <input type="text" class="form-control" id="category" placeholder="Project Category" name="project_category">
            </div>
